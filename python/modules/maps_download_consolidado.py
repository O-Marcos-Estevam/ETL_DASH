...
data_fim = "08/07/2025"   # Exemplo: termine na sexta-feira ou sábado para pegar sexta útil
...
def run_maps_completo (url_maps, download_path, pdf_path, maps_path, username_maps, password_maps, data_inicio, data_fim, baixar_xlsx, baixar_pdf, ativo, passivo, lista_fundos):
...
if __name__ == "__main__":
    run_maps_completo (url_maps, download_path, pdf_path, maps_path, username_maps, password_maps, data_inicio, data_fim, baixar_xlsx, baixar_pdf, ativo, passivo, lista_fundos)